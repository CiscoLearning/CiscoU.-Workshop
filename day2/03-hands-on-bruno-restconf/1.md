...
1. Download the collection file from this repostory by right-clicking on [this link](raw gh link) and saving the file to your local machine.  Remember where you saved it!

### Step 1: Open Bruno and Import the Collection and Environment

Download the RESTCONF collection and environment files from this repository [here](raw gh link). Open Bruno and import the collection and environment files by following these steps:
