...
2. Navigate to the working directory: `8-Hands-on-Netmiko-and-CML/code/challenge/source`
...
1. In the `code/challenge/source` folder, open the file named `netmiko_test.py`.
...
1. In the `code/challenge/source` folder, open the file named `netmiko_multi_device.py`.
...
1. Observe the contents of the file `cisco_devices.py` in the `code/challenge/source` folder:
...
2. In the `code/challenge/source` folder, open the file named `netmiko_function.py`.
...
- In the `code/challenge/source` folder, there is an empty file named `__init__.py`—do you know it's purpose? (Hint: it's not strictly needed after Python 3.3)
...
1. In the `code/challenge/source` folder, open the file named `netmiko_config.py`.
