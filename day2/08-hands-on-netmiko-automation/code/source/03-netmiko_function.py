# H - Fill in the blanks in the imports section
...
# I - Fill in the blanks to complete each code block of the function
...
# J - Fill in the blanks to complete each code block in the for loop
