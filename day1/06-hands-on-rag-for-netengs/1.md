...
2) Click `Projects` and give it a name  `Network Assistant` and click on `Create Project`.
...
1) Click on the `+` symbol and select `Add photos & files`.
